        ...
        <div class="row justify-content-center">
            <div class="col-9">
                ...
                <ul class="list-group">
                    ...
                    <li v-else class="list-group-item  justify-content-between" v-for="poke in favoritos" :key="poke.id">
                        <span>
                            <img :src="poke.sprites?.front_default" alt="">
                        </span>
                        <h5 class="align-self-center">{{ poke.name }}</h5>
                        <span class="align-self-center">
                            <router-link class="btn btn-sm btn-primary me-2" :to="`/pokemons/${poke.name}`">Mas
                                info</router-link>
